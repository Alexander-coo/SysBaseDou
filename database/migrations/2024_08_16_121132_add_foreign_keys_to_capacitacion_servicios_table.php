...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('capacitacion_servicios', function (Blueprint $table) {
            ...
            $table->foreign(['estado_id'], 'fk_servicios_estado1')->references(['id'])->on('capacitacion_estados')->onUpdate('NO ACTION')->onDelete('NO ACTION');
            $table->foreign(['user_id'], 'fk_servicios_usuarios1')->references(['id'])->on('capacitacion_users')->onUpdate('NO ACTION')->onDelete('NO ACTION');
        });
    }
    ...
    public function down()
    {
        Schema::table('capacitacion_servicios', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_servicios_estado1');
